  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center max-w-4xl mx-auto py-12">
      ...
      >
        ...
        <span className="text-xs font-semibold tracking-wider text-slate-500 uppercase">LGBTQ+ Voices</span>
      </motion.div>
      ...
      >
        Real Stories of <em className="text-[#8B5CF6] not-italic">Finding Yourself</em>
      </motion.h1>
